                ...
                <form action="{{ route('mahasiswa.update', $mahasiswa->id) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="nomor_hp" name="nomor_hp" type="text" class="mt-1 block w-full" value="{{ old('nomor_hp', $mahasiswa->nomor_hp) }}" required />
                    ...
                    <div class="mt-4">
                        ...
                        <textarea id="alamat" name="alamat" rows="3" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>{{ old('alamat', $mahasiswa->alamat) }}</textarea>
